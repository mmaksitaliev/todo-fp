...
it('test curry', () => {
  ...
  const sumCurried = utils.curry(sum)
  const step1 = sumCurried(5)
...
it('test pipe', () => {
  ...
  const sumAndMultiply = utils.pipe(sum, multiply5)
...
it('test allTrue', () => {
  ...
  const allTrue = utils.allTrue([mockTrue1, mockTrue2])
  ...
  const oneFalse = utils.allTrue([mockTrue1, mockTrue2, mockFalse2])
